...
class AnimationController {
    ...
    public render() {
        ...
        // 绘制星星
        ctx.fillStyle = 'rgba(99, 102, 241, 0.8)' // Primary color with transparency
    ...
    private drawTrail(t1: number) {
        for (let i = 0; i < this.trailLength; i++) {
            ...
            // Use gradient colors from primary to secondary-brand
            const alpha = f * 0.8
            this.ctx.fillStyle = `rgba(139, 92, 246, ${alpha})` // Secondary brand color
            this.ctx.lineWidth = sw
